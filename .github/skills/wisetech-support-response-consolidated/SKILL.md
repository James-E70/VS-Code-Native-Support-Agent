...
- If any attachment review failed or remained unavailable, include exactly one line in the final chat response: `FILES COULD NOT BE PARSED: <comma-separated file names>`. Never omit that chat warning line merely because the client-facing response correctly excludes it.
